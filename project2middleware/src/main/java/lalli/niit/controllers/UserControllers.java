package lalli.niit.controllers;
...
import lalli.niit.Dao.UserDao;
import lalli.niit.models.ErrorClazz;
...
private UserDao userDao;
	...
	public ResponseEntity<?> protectedResource(HttpSession session){//logged in user can access the resource
		System.out.println(session.getId());
